module Sapi
  class Trade::AnnualReportUpload < Sapi::Base
    ...
    belongs_to :epix_creator, class_name: Epix::User, foreign_key: :epix_created_by_id
    belongs_to :sapi_creator, class_name: Sapi::User, foreign_key: :created_by_id
    ...
    belongs_to :epix_updater, class_name: Epix::User, foreign_key: :epix_updated_by_id
    belongs_to :sapi_updater, class_name: Sapi::User, foreign_key: :updated_by_id
